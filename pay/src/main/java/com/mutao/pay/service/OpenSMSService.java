...
import com.mutao.pay.controller.PayController;
 ...
 */
@Service
public class OpenSMSService {
    Logger logger = LoggerFactory.getLogger(OpenSMSService.class);

    @Value("${merId}")
    private String merId;

    public Map<String, String> openSMS(String accNo,String phoneNo,String token) throws ServletException, IOException {
...
//        ////////////如果商户号开通了【商户对敏感信息加密】的权限那么需要对 accNo,phoneNo加密使用：
        ...
        logger.info("开通短信请求报文"+JSONObject.toJSONString(reqData));
        logger.info("开通短信返回报文"+JSONObject.toJSONString(rspData));

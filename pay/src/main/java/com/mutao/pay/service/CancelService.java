...
public class CancelService {
    ...
    public Map<String, String> cancel(String txnAmt, String origQryId) throws ServletException, IOException {
...
//		data.put("reqReserved", Base64.encodeBase64String("任意格式的信息都可以".toString().getBytes(DemoBase.encoding)));
        ...
        logger.info("消费撤销请求报文"+ JSONObject.toJSONString(reqData));
        logger.info("消费撤销返回报文"+JSONObject.toJSONString(rspData));
